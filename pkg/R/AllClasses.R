...
#'
#'    @slot X Middle values on x-axis.
#'    @slot method Middle values on y-axis.
#'    @slot name Boundaries of bins.
#'  
...
#' Class fro DDPlot
#'
#'    @slot X Object of class \link{Depth}.
#'    @slot Object of class \link{Depth}.
#'  
#' @export 
